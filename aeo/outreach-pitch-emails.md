# Tier-1 Outreach Pitch Emails — CarShake

_Template kit for the 10 highest-leverage third-party mentions. Each pitch is tailored to the publication's angle. All lead with the **founder story** ($4,200 Ferrari/Beverly Hills valet) because it's the single most compelling, naturally-linkable hook. Personalize the bracketed `[...]` fields._
...
## 1. Automotive consumer — Jalopnik / The Drive / Autoblog

**Subject:** A valet scraped a $4,200 splitter and the driver had no proof — so he built a free app

**To:** tips@[publication].com / the specific writer who covers car-ownership or consumer-protection

Hi [Writer first name],

I read your piece on [specific recent article — e.g., "the rise of hidden fees at hotel parking"] and thought you'd be interested in a story that's been quietly building in the same space.
...
I think this lands for [publication]'s readers because every car owner has felt that exact "I handed them the keys and now there's a scratch" helplessness. Happy to put you in touch with the founder for the full story — he's got the receipts (literally), the repair invoice, and the bailment-law research that came out of it. He can also speak to specific US-city valet laws that vary meaningfully.
...
## 2. Travel / Points — The Points Guy / TripSavvy

**Subject:** Hotel valets are a top source of damage disputes — and there's now a free tool to prove them

**To:** [Writer who covers hotel/airport tips]
...
I think this is a strong fit for [Publication] — possibly as a short "travel tool we tried" piece or a tip within a larger "how to protect yourself at hotel parking" article. Would also work as a quick roundup addition if you have a "apps every traveler should have in 2026" piece in the pipeline.

Happy to set up a demo or a founder interview. The tool is at carshake.online (free, no signup).
...
## 3. Consumer protection / Reviews — Wirecutter / Consumer Reports / NerdWallet

**Subject:** A free tool that closes the "valet damage" evidence gap (founder lost $4,200 building it)

**To:** [Writer on the automotive or insurance desk]

Hi [Writer first name],

I'm reaching out about a free consumer tool I think is worth a look for the [automotive / insurance] desk.
...
I can put you in touch with the founder for a demo or interview, and share the underlying bailment-law research (state-by-state differences are meaningful). If it fits your "tools we recommend" or a future roundup on car-ownership, I think it'd land well.
...
## 4. Tech / Founder story — TechCrunch / HackerNoon / Indie Hackers / Product Hunt

**Subject:** "I lost $4,200 to a valet and built a free app so it doesn't happen again" — founder story

**To:** [Reporter / editor on founder-story or consumer-tech desk]

Hi [Writer first name],

I want to flag a founder story I think is a strong fit for [Publication]'s [founder-story / build-in-public / consumer-tech] coverage.
...
- **Revenge-built-a-product origin story** — universally clickable, specific ($4,200, Beverly Hills, Ferrari-class car).
- **Consumer-tech angle** — AI-powered, web-first (PWA), solo founder, no funding.
- **Bailment-law angle** — a genuinely under-covered consumer-rights story (state laws vary, and almost no one knows the burden of proof is on them).
- **Distribution-ready** — free, no signup, immediately demoable.

I can put you in touch with [Founder name] for a 20-minute interview. He's got the repair invoice, the original valet receipt, the bailment-law research, and the build timeline. Happy to send over a fuller briefing doc if useful.
...
## 5. Product Hunt launch — short copy (day-of)

**Tagline:** Never pay for valet damage you didn't cause. Free 60-second AI car scan + QR handover proof.
...
**Built for:** drivers, frequent travelers, rental-car users, valet operators who want to do right by their customers.
**Tech:** PWA, Supabase, lightweight AI comparison layer, SHA-256 photo hashing.
**Free. No signup wall. No app store.**

I couldn't save my $4,200 — but I can save yours.
...
1. **Personalize every `[...]`** — generic mass emails get ignored. Read one recent piece by each writer and reference it in sentence one.
2. **Send Tuesday–Thursday, 7–9am the writer's local time** (lands at top of inbox).
3. **One follow-up after 4 business days** — one sentence: "Bumping this in case it got buried — happy to send the bailment-law briefing doc or set up a 15-min call."
4. **Track in a sheet:** publication, writer, date sent, status, response, coverage URL. This becomes your cited-domains list for AEO measurement.
5. **When coverage lands:** (a) add the URL to your `/citations.html` page, (b) submit to IndexNow, (c) repost on social with the writer tagged, (d) add a `sameAs` entry to your Organization schema pointing to the article.
6. **Tier-2 follow-up:** the same founder story works for podcasts (automotive, entrepreneur, indie-hacker). Pitch it as a 30-min guest segment, not a product review.
7. **Don't pitch all 10 in one week.** Stagger: 2–3 per week, personalized. Quality beats volume — one Wirecuster mention moves AI visibility more than ten low-DR reposts.
