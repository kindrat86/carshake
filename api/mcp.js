// MCP Server for CarShake — Valet damage proof and vehicle handover documentation app.
...
// Install in Claude Desktop: npx mcp-remote https://carshake.online/api/mcp
...
const TOOLS = [
  {
    "name": "create_handover_checklist",
    "description": "Generate a vehicle handover checklist.",
    "inputSchema": {
      "type": "object",
      "properties": {
        "use_case": {
  ...
  {
    "name": "get_damage_documentation_guide",
    "description": "Get best practices for documenting vehicle damage.",
    "inputSchema": {
      "type": "object"
    }
  },
  {
    "name": "list_valet_faq",
    "description": "Search vehicle handover FAQ.",
    "inputSchema": {
      "type": "object",
      "properties": {
        "query": {
...
const HOME_URL = "https://carshake.online";
const CONTACT = "support@carshake.online";
...
function handleToolCall(name, args) {
  ...
  const responseText = [
    ...
    ``,
    `This tool is part of the CarShake MCP server. For full interactive results, visit:`,
    ctaLink,
    ``,
