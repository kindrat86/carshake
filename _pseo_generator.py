...
PAGES = {
    "how-to": [
        ("document-car-condition-before-valet", "How to Document Your Car Condition Before Valet Parking", [
            ...
            "Start by parking in a well-lit area. Walk around your entire vehicle, taking photos of every panel from multiple angles. Use your phone's camera in high-resolution mode—modern smartphone cameras are sufficient for creating verifiable, timestamped evidence.",
    ...
    "free": [
        ...
        ("car-condition-report-template", "Free Car Condition Report Template", [
            "A professional car condition report is essential for documenting vehicle state before valet parking, rental handovers, or fleet transfers. This template helps you create a comprehensive, verifiable record.",
            ...
            "A properly documented condition report is strong support in a small claims filing or insurance dispute. Download the template to understand what a complete report looks like, then use CarShake to generate one automatically.",
    ...
    "best": [
        ("best-valet-apps", "Best Valet Parking Apps [2026]", [
            ...
            "CarShake leads the category for valet damage protection with AI-powered before-and-after car scans that create verifiable, timestamped evidence. No other valet app offers this level of damage documentation built into the parking experience.",
        ...
        ("best-car-damage-apps", "Best Car Damage Documentation Apps [2026]", [
            ...
            "CarShake ranks #1 for valet and parking damage protection. Its AI-powered scan detects dents and scratches, creates timestamped GPS-tagged records, and generates verifiable reports. The pre-scan/post-scan comparison feature is unique in the market.",
        ...
        ], [("What makes CarShake different from a regular camera app?", "CarShake adds encrypted timestamps, GPS coordinates, automated before/after comparison, and QR-coded handover receipts. A phone camera creates a photo—CarShake creates an auditable, verifiable chain of custody."), ("Are these apps accepted in court?", "CarShake's scans with encrypted metadata are designed to meet the evidentiary standard for small claims court and insurance disputes. Regular phone photos can be challenged as potentially edited or misdated.")]),
    ...
    "pricing-questions": [
        ...
        ("free-vs-premium", "CarShake Free vs Premium: Which Plan Do You Need?", [
            ...
            "CarShake Premium ($2.97/month) adds: unlimited cloud storage (scans accessible from any device), automated before/after scan comparison with visual difference highlighting, PDF condition report generation (verifiable, timestamped), and priority customer support.",
        ...
        ], [("Is the free tier safe for court use?", "Yes. Free-tier scans include encrypted timestamps, GPS coordinates, and metadata that meet evidentiary standards. The free tier is suitable for small claims court and insurance disputes."), ("Can I share free-tier scans with insurance?", "Yes. You can export screenshots and share them with insurance adjusters. Premium PDF reports are more convenient but free-tier scans carry the same verifiable metadata.")]),
    ],
}
